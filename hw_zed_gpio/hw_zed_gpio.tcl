...
#
# hw_zed_gpio.tcl: Tcl script for re-creating project 'hw_zed_gpio'
#
# Generated by Vivado on Mon Nov 08 15:39:09 -0500 2021
...
#
# 1. This project restoration tcl script (hw_zed_gpio.tcl) that was generated.
#
...
set _xil_proj_name_ "hw_zed_gpio"
...
set script_file "hw_zed_gpio.tcl"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/board_repo/xilinx_board_store"]" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse top_bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/hw_zed_gpio.gen/sources_1/bd/top_bd/hdl/top_bd_wrapper.vhd" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "auto_incremental_checkpoint.directory" -value "$origin_dir/hw_zed_gpio.srcs/utils_1/imports/synth_1" -objects $obj
...
set obj [get_runs impl_1]
set_property -name "auto_incremental_checkpoint.directory" -value "$origin_dir/hw_zed_gpio.srcs/utils_1/imports/impl_1" -objects $obj
